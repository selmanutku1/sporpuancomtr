...
const oldBlock = `{/* TOP ROW: Overall Rating + Sub-criteria Rings + Percentage Rings */}
...
const newBlock = `{/* TOP ROW: Overall Rating + Percentage Rings */}
...
if (content.includes('{/* TOP ROW: Overall Rating + Sub-criteria Rings + Percentage Rings */}')) {
  content = content.replace(oldBlock, newBlock);
  fs.writeFileSync('src/components/EventDetailModal.tsx', content);
  console.log('Successfully updated modal layout to use linear bars.');
} else {
  console.log('Block not found in EventDetailModal.tsx');
}
